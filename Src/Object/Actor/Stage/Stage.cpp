...
void Stage::InitCollider(void)
{
	...
	ownColliders_.emplace(static_cast<int>(ColliderBase::SHAPE::MODEL), std::vector<ColliderBase*>{ colModel });
	...
	// 壁のコライダ割り当て
	ownColliders_.emplace(static_cast<int>(ColliderBase::SHAPE::MODEL), std::vector<ColliderBase*>{ wallCollider });
